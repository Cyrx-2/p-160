...
input_file_name.place(relx=0.61,rely=0.03, anchor= CENTER)
...
run_button=Button(root,image=run_img,text="Run File", command=runFile)
run_button.place(relx=0.31,rely=0.03,anchor= CENTER)
